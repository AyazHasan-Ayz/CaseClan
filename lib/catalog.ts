...
export type Design={name:string;font:string;textColor:string;style:string;upload?:string;filename?:string;instructions?:string;customization?:Omit<Customization,'layers'>&{layers:Omit<import('./customizer').Layer,'src'>[]};artifactId?:string;preview?:string};
