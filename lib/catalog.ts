import {designAssets,phoneAsset} from './assets';
...
export type Design={name:string;font:string;textColor:string;style:string;templateId?:string;personalization?:Record<string,string>;upload?:string;filename?:string;instructions?:string;customization?:Customization;artifactId?:string;preview?:string};
