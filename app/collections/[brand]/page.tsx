...
export async function generateMetadata({params}:{params:Promise<{brand:string}>}){const {brand}=await params;const name=brand==='iphone'?'iPhone':'Samsung';return {title:`${name} Cases`,description:`Explore fixed CASECLAN designs for ${name}.`}}
